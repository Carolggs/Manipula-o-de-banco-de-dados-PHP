...
<body class="bg-light">
    ...
    <?php
        ...
        if(isset($_GET["idCuidador"]) and !empty($_GET["idCuidador"])){
            ...
            if(Cuidador::existeId($idCuidador)){
                CuidadorPet::deletar_id_cuidador($idCuidador);
                Cuidador::excluir_cuidador($idCuidador);
                echo "<p>Cuidador Excluído</p>";
                echo "<p><a href='ListaCuidadores.php'>Voltar</a></p>";
            }else{
                echo "Cuidador não existe ";
            }
